...
{\gt \large 阪大RCNP, KEK$^A$, 東大CNS$^B$, 総研大$^C$ \\ 加島駿一, 白鳥昂太郎, 野海博之, 五十嵐洋一$^A$, 郡司卓$^B$, 鈴木謙, 本多良太郎$^A$, 古川史也, Che-sheng Lin$^C$, 他T103 コラボレーション, 他SPADI Alliance}\\[5pt]
...
{\large \it RCNP, KEK\,$^A$, CNS\,$^B$, SOKENDAI\,$^C$}\\

{\large \bf S. Kashima, K. Shirotori, H. Noumi, Y. Igarashi$^A$, T. Gunji$^B$, K.
Suzuki, R. Honda$^A$, F. Furukawa, Che-sheng Lin$^C$, for T103 Collaboration, and for SPADI Alliance}\\
...
実験で想定される高い信号レートの環境下で複雑なチャームバリオン生成事象を効率的に収集するには複雑な事象選別が要求されるため、
